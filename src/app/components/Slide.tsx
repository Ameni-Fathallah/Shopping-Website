...
//the propsType is usually defined as an interface or type alias that describes the expected props.
...
const Slide :React.FC<propsType>= ({img,title,mainTitle,price}) => {
  return (
    <div className='outline-none border-none relative'>
        ...
        top-[50%] -translate-y-[50%] space-y-2 lg:space-y-10  sm:bg-transparent p-4 
        sm:p-0 rounded-lg sm:rounded-none'>
            
            <h3 className='text-accent text-[24px] lg:text-[28px]'>{title}</h3>
            <h2 className='text-blacklish text-[26px] md:text-[30px] lg:text-[44px] font-bold leading [1,2]'>
                {mainTitle}
            </h2>
            ...
            inline-block cursor-pointer hover:bg-blacklish'>Shop Now</div>   
        </div>

            <Image className="w-[100%] h-[350px] md:h-auto rounded-xl  object-cover object-right md:object-left-bottom  "
            src={img}
            alt="banner"
            width={2000}
            height={2000}/>
